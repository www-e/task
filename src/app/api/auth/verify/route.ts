...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!response.ok) {
      ...
      console.error('Backend verify error:', errorText);
      return NextResponse.json({ error: 'Verification failed', details: errorText }, {
    ...
    console.error('Auth verification API route error:', error);
